...
mongoose.connect('mongodb+srv://prakhar2227:MYT0iRYgpHgw89BI@cluster0.dm1mi0h.mongodb.net/?retryWrites=true&w=majority', {
});
...
app.get('/', (req, res) => {
    res.send('Hello, this is the Yoga Classes Admission Form backend!');
});
